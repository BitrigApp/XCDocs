...
package final class MADServiceObject: PrivateObject {
    ...
    package init() throws {
        ...
        guard let makeService = Self.objcClassMethod(
            cls,
            selector: Self.serviceSelector,
            as: MADServiceFactoryMethod.self
        ) else {
            throw BridgeError(.selectorUnavailable, "Missing +service on MADService")
        }
...
private typealias MADServiceFactoryMethod =
