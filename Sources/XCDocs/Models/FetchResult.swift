...
@available(macOS 26, *) public struct FetchResult: Codable, Hashable, Sendable {
    ...
    public init(identifier: String, framework: String?, kind: DocumentationKind?, title: String?, content: String?) {
